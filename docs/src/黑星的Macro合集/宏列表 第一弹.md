...
> [!INFO]
> 
> 链接：[random.js](https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/utils/random.min.js) [macro-utils.js](https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/macro/macro-utils.min.js) [expr-parser.js](https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/macro/expr-parser.min.js)
> 
> <a link='#' id='expr-parser'>点击下载</a>
...
onMounted(() => {
     const jsFilesGroup = {
          'expr-parser': [
            'https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/utils/random.min.js',
            'https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/macro/macro-utils.min.js',
            'https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/macro/expr-parser.min.js'
          ]
        };
        setTimeout(function () {
                    ...
                    element.addEventListener('click', async (event) => {
                        ...
                        try {
                            const contents = await Promise.all(
                                jsFiles.map(file => 
                                    axios.get(file, { responseType: 'text', withCredentials: true }) // Set withCredentials for CORS
