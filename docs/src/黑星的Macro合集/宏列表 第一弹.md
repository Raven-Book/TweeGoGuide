...
> [!WARNING]
> 
> 链接：[random.js](https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/utils/random.min.js) [macro-utils.js](https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/utils/macro-utils.min.js) [generate-npc.js](https://github.com/Raven-Book/TweeGoGuide/tree/master/src/js/utils/generate-npc.min.js)
>
> <h5>可用功能：</h5>
>
> 1. 随机生成NPC
...
<<pushnpc '$npcs' 5>>_start,_end<</push-npc>>
<!-- 增加5个随机NPC，固定种族为精灵，该格式不支持固定特质 -->
<<pushnpc '$npcs' 5 'race' '精灵'>>_start,_end<</push-npc>>
<!-- 增加5个随机NPC，固定种族为精灵，固定特质为脆弱 -->
<<pushnpc '$npcs' 20 `{traits: ['脆弱'], race: '精灵'}`>>_start,_end<</pushnpc>>
