...
## 1. 随机宏
> [!INFO]
> 链接: [random.js](https://raven-book.github.io/TweeGoGuide/js/utils/random.min.js) [prize.js](https://raven-book.github.io/TweeGoGuide/js/macro/prize.min.js)
...
> [!INFO]
> 
> 链接：[random.js](https://raven-book.github.io/TweeGoGuide/js/utils/random.min.js) [macro-utils.js](https://raven-book.github.io/TweeGoGuide/js/macro/macro-utils.min.js) [expr-parser.js](https://raven-book.github.io/TweeGoGuide/js/macro/expr-parser.min.js)
> 
...
onMounted(() => {
     const jsFilesGroup = {
          'expr-parser': [
            ...
            'https://raven-book.github.io/TweeGoGuide/js/macro/macro-utils.min.js',
