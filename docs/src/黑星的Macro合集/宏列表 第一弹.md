...
> [!INFO]
> 
> 链接: [redo-utils.js](https://raven-book.github.io/TweeGoGuide/js/utils/redo-utils.min.js)
...
<!-- 使用CSS选择器 -->
<<changes "[name='radiobutton-playersex']">>
<!-- 使用属性名，注意该宏仅能为radiobutton添加change事件 -->
<<redo-radio player.sex>>
```
